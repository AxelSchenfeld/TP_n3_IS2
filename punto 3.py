...
if __name__ == "__main__":
    print("\n\n")
    print("Creando una hamburguesa para entregar en mostrador")
    client_code(HamburguesaMostradorCreator())
    print("\n")

    print("Creando una hamburguesa para retirar por el cliente")
    client_code(HamburguesaRetiroCreator())
    print("\n")

    print("Creando una hamburguesa para enviar por delivery")
